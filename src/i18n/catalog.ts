...
export const CORE_CATALOG_EN: MessageCatalog = {
  ...
  'core.file.expired': 'Temporary file has expired',
  'core.file.invalid-checksum': 'Invalid upload checksum',
  'core.file.invalid-disposition': 'Invalid file disposition',
  'core.file.invalid-meta': 'Invalid uploaded file metadata',
  'core.file.invalid-temporary-options': 'Temporary file options cannot override visibility or lifetime',
  'core.file.invalid-upload': 'Uploaded file failed validation',
  'core.file.invalid-visibility': 'Invalid file visibility',
  'core.file.not-found': 'File not found',
  'core.file.public-upload-disabled': 'Public file uploads are disabled',
  ...
  'core.file.too-large': 'Uploaded file is too large',
  'core.file.upload-completing': 'File upload completion is already in progress',
  'core.file.upload-expired': 'File upload has expired',
  'core.file.upload-failed': 'File upload failed',
  'core.file.upload-not-pending': 'File upload is not pending',
  'core.file.upload-promotion-failed': 'Uploaded object could not be finalized',
  'core.file.upload-verification-failed': 'Uploaded object could not be verified',
  // action history
...
export const CORE_CATALOG_VI: MessageCatalog = {
  ...
  'core.file.expired': 'Tệp tạm đã hết hạn',
  'core.file.invalid-checksum': 'Checksum tải lên không hợp lệ',
  'core.file.invalid-disposition': 'Cách hiển thị tệp không hợp lệ',
  'core.file.invalid-meta': 'Metadata tệp tải lên không hợp lệ',
  'core.file.invalid-temporary-options': 'Tùy chọn tệp tạm không được thay đổi quyền truy cập hoặc thời hạn',
  'core.file.invalid-upload': 'Tệp tải lên không vượt qua kiểm tra',
  'core.file.invalid-visibility': 'Quyền truy cập tệp không hợp lệ',
  'core.file.not-found': 'Không tìm thấy tệp',
  'core.file.public-upload-disabled': 'Chức năng tải tệp public đang tắt',
  ...
  'core.file.too-large': 'Tệp tải lên quá lớn',
  'core.file.upload-completing': 'Tệp đang được hoàn tất tải lên',
  'core.file.upload-expired': 'Phiên tải tệp lên đã hết hạn',
  'core.file.upload-failed': 'Tải tệp lên thất bại',
  'core.file.upload-not-pending': 'Tệp không ở trạng thái chờ tải lên',
  'core.file.upload-promotion-failed': 'Không thể hoàn tất object đã tải lên',
  'core.file.upload-verification-failed': 'Không thể xác minh object đã tải lên',
  // action history
